				...
				<div class="join-box well">
					<form action="join_result.php" method="post">
						...
						<div class="form-group">
							<p>아이디</p>
							<input name="user_id" value='' type="id" class="form-control" id="user_id" />(영문소문자/숫자, 4~16자)
						...
						<div class="form-group">
							<input type="submit" class="btn btn-default btn-login-submit btn-block m-t-md" value="JOIN MEMBER"/>
						</div>
