...
<div>
    ...
    $cate = $_GET['cate'];
    $sql = "SELECT * FROM product_board WHERE cate='" . $cate . "' ORDER BY no DESC ";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT *  FROM product_board WHERE cate='" . $cate . "' ORDER BY no DESC  LIMIT $start_post, $post_num_per_page";
        ...
        for ($num_page = $start_page;
            ...
            <li><a <? if ($page == $num_page) {
                    ...
                    echo "class = 'active'";
                        ...
                        href="list.php?cate=<?= $cate ?>&page=<?php echo $num_page; ?>" ><?php echo $num_page; ?></a></li>
        <? }
